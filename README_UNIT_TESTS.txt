...
- flash 6, 7, 8, 9: open the 'indexFl.html' file located in 'test_bin'
- javascript: open the 'indexJs.html' file located in 'test_bin' (there seems to be a bug on Safari and test messages are not traced)
- neko: open terminal and change the direcotry path to the 'test_bin' folder. Next type 'neko testRunner.n' (you must have nekoVM installed)
--------------------------------------------------------------------------
